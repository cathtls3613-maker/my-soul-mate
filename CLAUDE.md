...
my-soul-mate is a Gen Z dating app that connects students across private universities, with a paid tier unlocked via Stripe checkout.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "249082257+cathtls3613-maker@users.noreply.github.com"
  git config user.name "cathtls3613-maker"
  ```
